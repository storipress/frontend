...
export type LanguageKey = keyof Language
export type LanguageValue = Language[keyof Language]
export interface LanguageItem {
  key: LanguageKey
  value: LanguageValue
}

export const languageList = Object.entries(language).map(([key, value]) => ({ key, value })) as LanguageItem[]
