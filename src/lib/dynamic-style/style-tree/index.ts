...
export function wrapUserTree(userStyleTree: StyleTree) {
  return {
    children: {
      article: userStyleTree,
    },
    name: STYLE_TREE_FRAGMENT,
    styles: {},
  }
}
...
export function insertToTreeWithCascadeDown(
  ...
  insertStyles(styles, normalized)
  node.meta = newMeta
  return tree
}
